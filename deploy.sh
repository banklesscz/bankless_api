...
docker rm -f bankless_mailchimp_api
docker run --detach --restart=always --env-file .env -p 8000:8000 --name bankless_mailchimp_api bankless_mailchimp_api:$IMAGE_TAG
echo "[DEPLOY.SH] DONE"
